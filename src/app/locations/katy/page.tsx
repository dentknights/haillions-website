...
export const metadata: Metadata = {
  title: "Paintless Dent Repair Katy TX | Mobile PDR Service",
  description: "Expert mobile paintless dent repair in Katy, TX. Hail damage, door dings & creases fixed with lifetime warranty. Free estimates. Serving Cinco Ranch, Seven Meadows & Grand Lakes.",
  keywords: ["paintless dent repair Katy", "PDR Katy TX", "hail damage repair Katy", "mobile dent repair Katy", "door ding removal Katy"],
  ...
  alternates: {
    canonical: "https://haillions.com/locations/katy",
  },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://haillions.com/locations/katy",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Paintless Dent Repair in Katy, TX",
      },
    ],
  },
  twitter: {
...
const services = [
  ...
  },
  {
    ...
    description: "We bring professional dent repair to you! Our fully-equipped mobile units serve Katy and surrounding areas.",
  },
];
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: "Katy", url: "https://haillions.com/locations/katy" },
]);

export default function KatyLocationPage() {
  return (
    <>
      <Header />
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#0a0f1a] via-[#111827] to-[#0a0f1a]" aria-labelledby="hero-heading">
          <div className="absolute inset-0 z-0">
            ...
            <Image
              ...
              alt="Professional paintless dent repair in Katy"
              fill
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-24">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-[#94a3b8] mb-8 max-w-2xl mx-auto leading-relaxed">
                Katy residents trust Hail Lions for fast, professional paintless dent repair. We serve Cinco Ranch, Seven Meadows, Grand Lakes, and all Katy neighborhoods. Expert mobile PDR services with lifetime warranty. 
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 id="services-heading" className="text-3xl md:text-4xl font-bold mb-4 text-silver">
                Professional PDR Services in Katy
              </h2>
              ...
              <div className="relative">
                <div className="relative h-[400px] lg:h-[500px] rounded-2xl overflow-hidden border border-[#1e3a5f]">
                  <Image
                    ...
                    alt="PDR technician working in Katy"
                    fill
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h2 id="why-heading" className="text-3xl md:text-4xl font-bold mb-4 text-silver">
                    The Hail Lions Difference in Katy
                  </h2>
                  <p className="text-lg text-[#64748b] leading-relaxed">
                    We're not just fixing dents—we're restoring your peace of mind. Our commitment to excellence has made us the most trusted PDR service in Katy.
                  </p>
                </div>
        ...
        <section className="py-20 bg-gradient-to-r from-[#1e3a5f]/50 to-[#0f172a]/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-[#94a3b8] mb-8 max-w-2xl mx-auto">
              Get a free estimate in 30 minutes. Our mobile team serves all of Katy and surrounding areas.
            </p>
